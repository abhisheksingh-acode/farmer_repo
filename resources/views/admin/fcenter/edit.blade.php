...
@section('title', 'edit facilitator')
@section('content')
    <div class=" main-content flex-wrap flex-md-nowrap pb-3 pt-3 px-auto mx-auto">
        <div class="container mx-auto mb-5">
            <div class=" uppercol my-3 my-md-5  mx-1 px-0 px-sm-1 mx-sm-4">
                <p>Facilitator Center <span>/ Add Facilitator Center</span></p>
                <div class="d-flex justify-content-between">
                    <h4 class="text-nowrap">Edit Facilitator Center</h4>
                </div>
            </div>

            <div class="mt-4 p-4 mb-4 bg-white px-5 shadow-sm rounded-3 add_order">
                <form action="{{ route('admin.fcenter.edit', ['id' => $data->id]) }}" method="post">
                    ...
                    <div class="col-12   row g-3 align-items-center my-1">
                        ...
                        <div class="col-9 col-sm-10 mx-sm-0 px-sm-0">
                            <input type="number" id="inputpincode" class="form-control" placeholder="Pincode"
                    ...
                    <div class="col-12   row g-3 align-items-center my-1">
                        <div class="col-3 col-sm-2">
                            <label for="inputtext" class="col-form-label">Phone No.</label>
                        </div>
                        <div class="col-9 col-sm-10 mx-sm-0 px-sm-0">
                            <input type="number" id="inputtext" class="form-control" placeholder="Phone No." name="phone"
                                value="{{ $data->phone }}">
                            @error('phone')
                                <span class="text-danger">{{ message }}</span>
                            @enderror
                    ...
                    <div class="col-12   row g-3 align-items-center my-1">
                        ...
                        <div class="col-9 col-sm-10 mx-sm-0 px-sm-0">
                            <input type="email" id="inputemail" class="form-control" placeholder="fc1@gmail.com"
