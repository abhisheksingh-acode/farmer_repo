    ...
    <div class=" main-content flex-wrap flex-md-nowrap p-4 ">
        <div class="mx-5">
            ...
            <div class="container-fluid mx-auto bg-white py-4 px-3">
                ...
                {{-- show alert fail and success --}}
                @include('admin.include.fail')
                @include('admin.include.success')


                <form action="{{ route('admin.dayselling.create') }}" method="POST" class="row align-items-end">
                    @csrf
                    ...
                    <div class="col-5 form-group">
                        ...
                        <input type="date" class="form-control" id="datetime" name="date" value="{{ old('date') }}">
                    </div>
