...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admins') }}/css/allfarmer.css" />
    <link rel="stylesheet" href="{{ asset('admins') }}/css/dashboard.css" />
    <link rel="stylesheet" href="{{ asset('admins') }}/css/add.css">
    <link rel="stylesheet" href="{{ asset('admins') }}/css/login.css">
    <link href="{{ asset('admins') }}/css/sidebars.css" rel="stylesheet">
