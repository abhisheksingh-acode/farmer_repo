<div class="menurow ms-auto mb-4 p-0">
        <div class=" menu  d-flex justify-content-between px-1 m-0 px-md-5"> 
            ...
            <div class="rounded-circle mx-1 mx-sm-3"><i class="fa-regular fa-bell"></i></div> -->
                ...
                <div class="sidebar-foot dropdown ms-3">
                  <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle me-2 my-auto">
                    <strong>mdo</strong>
                  </a>
