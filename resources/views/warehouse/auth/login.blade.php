...
<body style="height: 100vh;" class="bg-light d-flex justify-content-center align-items-center">
    <div class="w-fit h-50">
        <span class="bg-linear-g px-3 py-2 d-block text-white text-center text-uppercase">Warehouse Login</span>
        <form action="{{ route('warehouse.login') }}" method="post" id="admin-login-form" autocomplete="off"
