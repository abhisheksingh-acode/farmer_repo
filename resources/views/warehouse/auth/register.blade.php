...
<body style="height: 100vh;" class="bg-light d-flex justify-content-center align-items-center">
    <div class="w-50 h-auto">
        <span class="bg-linear-g px-3 py-2 d-block text-white text-center text-uppercase">Facilitator Register</span>
        <form action="{{ route('fcenter.create') }}" method="post" id="admin-login-form" autocomplete="off"
            ...
            <div class="row">
                <div class="form-group col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        value="{{ old('name') }}" aria-describedby="namevalidate" name="name">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone"
                        value="{{ old('phone') }}" aria-describedby="phonevalidate" name="phone">
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                        value="{{ old('address') }}" aria-describedby="addressvalidate" name="address">
                    <div id="addressvalidate" class="invalid-feedback">
                        @error('address')
                            {{ $message }}
                        @enderror
                    </div>
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('pincode') is-invalid @enderror" id="pincode"
                        value="{{ old('pincode') }}" aria-describedby="pincodevalidate" name="pincode">
                    <div id="pincodevalidate" class="invalid-feedback">
                        @error('pincode')
                            {{ $message }}
                        @enderror
                    </div>
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="password" class="form-control @error('c_password') is-invalid @enderror"
                        id="c_password" value="{{ old('c_password') }}" aria-describedby="c_passwordvalidate"
                        name="c_password">
                    <div id="c_passwordvalidate" class="invalid-feedback">
                        @error('c_password')
                            {{ $message }}
                        @enderror
                    </div>
