    ...
    <div class="main-content  pb-3 pt-4 px-auto  ">
        <div class="mx-auto mb-5" style="height:1000px;">
            ...
            <div class=" px-0 my-4 bg-white px-5 py-4 shadow-sm rounded-3 add_farmer">
                <form action="{{ route('fcenter.farmer.create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12 row g-3 align-items-center my-1">
                        ...
                        <div class="col-1 col-sm-1">
                            <img src="{{ asset('admins/asset/placeholder2.jpg') }}" alt="" id="photo" width="auto"
                                height="50px">
                        </div>
                    </div>
                    <div class="col-12 row g-3 align-items-center my-1">
                        ...
                        <div class="col-1 col-sm-1">
                            <img src="{{ asset('admins/asset/placeholder2.jpg') }}" alt="" id="doc" width="auto"
                                height="40px">
                        </div>
                    </div>
                    <div class="col-12 row g-3 align-items-center my-1 mb-3">
                        ...
                        <div class="col-9 col-sm-10">
                            <input type="text" id="inputtext" name="ac_number" class="form-control"
                                placeholder="Bank account no." value="{{ old('ac_number') }}">
                            @error('ac_number')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-9 col-sm-10">
                            <input type="text" id="inputtext" name="ac_holder" class="form-control"
                                placeholder="Bank account holders name" value="{{ old('ac_holder') }}">
                            @error('ac_holder')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
